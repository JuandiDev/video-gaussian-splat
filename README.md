...
**Video → splat (Windows, sin Cursor):** doble clic en [EMPEZAR.bat](EMPEZAR.bat) (instalación una vez: [INSTALLAR.bat](INSTALLAR.bat)). Guía: [COMO_EJECUTAR.md](COMO_EJECUTAR.md).
